    ...
    <html lang="en" className="h-full">
      <body className="relative min-h-full overflow-x-hidden bg-[#e6efff] text-slate-900 antialiased">
        <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-0">
          <div className="islamic-geometry-pattern absolute inset-0 opacity-[0.24]" />
        ...
        <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-20">
          <div className="islamic-geometry-overlay absolute inset-0 opacity-[0.12] mix-blend-multiply" />
        </div>
      </body>
    </html>
  );
