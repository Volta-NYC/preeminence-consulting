...
import { resourcesLinks } from "@/lib/site-data";
  ...
  return (
    <div className="min-h-screen bg-[#eaf0ff] text-slate-800">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-14 md:px-8">
        <h1 className="text-4xl font-extrabold text-[#11284a] md:text-5xl">Resources</h1>
        <p className="mt-4 max-w-4xl text-slate-600">
          Access events, groups, impact community pathways, and instant download resources from PPCA.
        </p>
